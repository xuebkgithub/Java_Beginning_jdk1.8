...
public class Customer {
  ...
  private banking7.domain.Account[] Account;
  ...
  public banking7.domain.Account getAccount(int ... Num){
    int index = 0;
...
//    }
  ...
  public banking7.domain.Account getAccount(){
    return this.Account[0];
  }

  public int setAccount(banking7.domain.Account _account){
  ...
  public int addAccount(banking7.domain.Account _account){
